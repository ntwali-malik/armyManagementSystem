...
const Training = () => {
    ...
    const handleUpdateTraining = async () => {
        try {
            const data = await TrainingService.updateTraining(editTraining.trainingID, editTraining, token);
            setTrainingSessions(trainingSessions.map(item => (item.trainingID === editTraining.trainingID ? data : item)));
    ...
    const handleDeleteTraining = async (trainingID) => {
        try {
            ...
            setTrainingSessions(trainingSessions.filter(item => item.trainingID !== trainingID));
        } catch (error) {
    ...
    const filteredTrainingSessions = trainingSessions.filter(item =>
    ...
    const paginatedTrainingSessions = sortedTrainingSessions.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage);
    ...
    return (
                    ...
                    <TableBody>
                        {paginatedTrainingSessions.map(item => (
                            <TableRow key={item.trainingID}>
                                ...
                                <TableCell>{item.soldier.firstName} {item.soldier.lastName}</TableCell>
                                <TableCell>
                                <IconButton edge="end" aria-label="edit" onClick={() => handleClickOpen(item)}>
                                    <EditIcon />
                                </IconButton>
                                <IconButton edge="end" aria-label="delete" onClick={() => handleDeleteTraining(item.trainingID)}>
                                    <DeleteIcon />
                                </IconButton>
                            </TableCell>
                        </TableRow>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleAddTraining(); }}>
            <TextField
                label="Training Name"
                name="trainingName"
            ...
            <Button type="submit" variant="contained" color="primary" fullWidth>Add Training</Button>
        </form>
        ...
        {editTraining && (
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleUpdateTraining} color="primary">Update</Button>
                </DialogActions>
            </Dialog>
        )}
    </div>
